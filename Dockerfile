...
RUN apt-get update && \
    apt-get install --no-install-recommends --quiet -y tini wget=1.20.3-1ubuntu1 unzip=6.0-25ubuntu1 \
        ca-certificates=20210119~20.04.1 libusb-1.0-0=2:1.0.23-2build1 libwxgtk3.0-gtk3-0v5=3.0.4+dfsg-15build1 && \
